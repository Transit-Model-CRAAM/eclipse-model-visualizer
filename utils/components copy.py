...
def create_connected_slider_and_number_input(page_name, variable_name, min_value, max_value, default_value, value_step, precision, disabled=False):
    ...
    @dash.callback(
        ...
        Input(f"{page_name}_{variable_name}_numeric_value", "n_blur"),
        State(f"{page_name}_{variable_name}_numeric_value", "value"),
        prevent_initial_call=True,
    )
    def connect_slider_and_numeric_values(slider, numeric_input, numeric):
...
def create_example_image_graph():
    ...
    rsun_slider_value, rsun_numeric_value = create_connected_slider_and_number_input("example_image", "rsun", 0, 5, 0.805, 0.001, 3)
    ...
    semi_eixo_slider_value, semi_eixo_numeric_value = create_connected_slider_and_number_input("example_image", "semi_eixo", 0, 2, 0.031, 0.001, 3)
    raio_planeta_slider_value, raio_planeta_numeric_value = create_connected_slider_and_number_input("example_image", "raio_planeta", 0, 5, 1.138, 0.001, 3)
    periodo_slider_value, periodo_numeric_value = create_connected_slider_and_number_input("example_image", "periodo", 0, 30, 2.219, 0.001, 3)
